...
var AppConfigService = (function () {
    function AppConfigService(http) {
        this.http = http;
        this.appConfigUrl = 'http://localhost:8000/api/appConfig'; // URL to web API
    }
    ...
    AppConfigService.prototype.updateAppConfig = function (appConfig) {
    ...
    AppConfigService.prototype.extractData = function (res) {
        var data = res.json();
        return data.appConfig || {};
    };
    AppConfigService.prototype.handleError = function (error) {
