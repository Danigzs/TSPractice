...
var SublimadoMainComponent = (function () {
    function SublimadoMainComponent(_appConfigService) {
        this._appConfigService = _appConfigService;
    }
    SublimadoMainComponent.prototype.ngOnInit = function () {
        //Called after the constructor, initializing input properties, and the first call to ngOnChanges.
        //Add 'implements OnInit' to the class.
        this.appConfig = new appConfig_1.AppConfig();
        this.getAppConfig();
    };
    SublimadoMainComponent.prototype.getAppConfig = function () {
        var _this = this;
        this._appConfigService.getAppConfig().subscribe(function (appConfig) {
            _this.appConfig = appConfig;
        });
    };
    return SublimadoMainComponent;
}());
SublimadoMainComponent = __decorate([
    core_1.Component({
...
exports.SublimadoMainComponent = SublimadoMainComponent;
//# sourceMappingURL=sublimado.mainscreen.js.map