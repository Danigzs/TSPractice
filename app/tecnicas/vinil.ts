export class Vinil {
  ...
  setTecnica(nombre:string,size:string,position:string,price:number,quantity:number,wItem:boolean, percentageSize:number, percentageType:number,costoTotal:number){
  ...
  copyNewTecnica(){
    ...
    _vinil.costoTotal = this.costoTotal
    return _vinil
  }
}